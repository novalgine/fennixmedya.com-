...
export default function BlogPost() {
  return (
    <div className="min-h-screen bg-background pt-header pb-20">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BlogPosting", headline: "Yapay Zeka ile Video Üretimi: AI Araçları mı Profesyonel Ekip mi?", author: { "@type": "Person", "@id": "https://fennixmedya.com/#person", name: "Semih Hasanoğlu", url: "https://fennixmedya.com/hakkimizda" }, datePublished: "2026-06-12", dateModified: "2026-06-18", publisher: { "@type": "Organization", name: "Fennix Medya" }, mainEntityOfPage: "https://fennixmedya.com/blog/yapay-zeka-ile-video-uretimi" }) }} />
    </div>
  );
}
