    ...
    <article className="min-h-screen bg-background pt-header">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-16 bg-muted/30 border border-border rounded-2xl p-8 text-center">
          ...
          <Link href="/hizmetler/sosyal-medya-video/klinikler" className="inline-flex items-center gap-2 bg-gradient-gold text-primary-foreground font-heading font-black px-6 py-3 rounded-xl hover:scale-105 active:scale-95 transition-all shadow-lg shadow-gold/20">
            Klinikler için sayfaya bakın <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
