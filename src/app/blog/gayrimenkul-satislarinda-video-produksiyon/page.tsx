...
export default function BlogPost() {
  return (
    <div className="min-h-screen bg-background pt-header pb-20">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BlogPosting", headline: "Gayrimenkul Satışlarında Video Prodüksiyonun Gücü", author: { "@type": "Person", "@id": "https://fennixmedya.com/#person", name: "Semih Hasanoğlu", url: "https://fennixmedya.com/hakkimizda" }, datePublished: "2026-05-22", publisher: { "@type": "Organization", name: "Fennix Medya" }, mainEntityOfPage: "https://fennixmedya.com/blog/gayrimenkul-satislarinda-video-produksiyon" }) }} />
    </div>
  );
}
